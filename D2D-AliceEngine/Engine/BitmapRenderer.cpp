...
{
	HRESULT hr = GetD2DRenderManager().CreateBitmapFromFile(
...
void BitmapRenderer::Render()
{
	...
	ID2D1DeviceContext7* context = GetD2DRenderManager().m_d2dDeviceContext.Get();
	...
	context->DrawRectangle(
		D2D1::RectF(0, 0,
			bmpSize.width, bmpSize.height), GetD2DRenderManager().m_pRedBrush.Get(), 5.0f);
}
