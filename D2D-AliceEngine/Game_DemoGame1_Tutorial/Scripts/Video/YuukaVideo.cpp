...
void YuukaVideo::OnStart()
{
	...
	m_yuuka->AddComponent<VideoComponent>()->LoadData(L"DemoGame1/BackGround/Yuuka3.mp4", 30, L"jpg", 95, true);
...
void YuukaVideo::Input()
{
	...
	if (Input::IsKeyPressed(VK_5))
	{
		...
		m_yuuka->AddComponent<VideoComponent>()->LoadData(L"DemoGame1/BackGround/asna.mp4", 30, L"jpg", 95, true);
		m_yuuka->GetComponent<VideoComponent>()->Play();
	}
	...
	if (Input::IsKeyPressed(VK_7))
	{
		m_yuuka->GetComponent<VideoComponent>()->Stop();
		m_yuuka->RemoveComponent<VideoComponent>(m_yuuka->GetComponent<VideoComponent>());
		m_yuuka->AddComponent<VideoComponent>()->LoadData(L"DemoGame1/BackGround/Aru_NewYear.webm", 30, L"jpg", 95, true);
		m_yuuka->GetComponent<VideoComponent>()->Play();
	}
	if (Input::IsKeyPressed(VK_8))
	{
		m_yuuka->GetComponent<VideoComponent>()->Stop();
		m_yuuka->RemoveComponent<VideoComponent>(m_yuuka->GetComponent<VideoComponent>());
		m_yuuka->AddComponent<VideoComponent>()->LoadData(L"DemoGame1/BackGround/AruDress.webm", 30, L"jpg", 95, true);
		m_yuuka->GetComponent<VideoComponent>()->Play();
	}
	if (Input::IsKeyPressed(VK_9))
	{
		m_yuuka->GetComponent<VideoComponent>()->Stop();
		m_yuuka->RemoveComponent<VideoComponent>(m_yuuka->GetComponent<VideoComponent>());
		m_yuuka->AddComponent<VideoComponent>()->LoadData(L"DemoGame1/BackGround/Alice.webm", 30, L"jpg", 95, true);
		m_yuuka->GetComponent<VideoComponent>()->Play();
	}
	if (Input::IsKeyPressed(VK_0))
	{
		m_yuuka->GetComponent<VideoComponent>()->Stop();
		m_yuuka->RemoveComponent<VideoComponent>(m_yuuka->GetComponent<VideoComponent>());
		m_yuuka->AddComponent<VideoComponent>()->LoadData(L"DemoGame1/BackGround/Mari_Sportswear.webm", 30, L"jpg", 95, true);
		m_yuuka->GetComponent<VideoComponent>()->Play();
	}
}
